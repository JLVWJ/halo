...
import com.lvwj.halo.core.utils.ConvertUtil;
...
public class EnumToStringConverter implements ConditionalGenericConverter {
  ...
  public Object convert(@Nullable Object source, TypeDescriptor sourceType, TypeDescriptor targetType) {
    ...
    AccessibleObject accessibleObject = ENUM_CACHE_MAP.computeIfAbsent(sourceClazz,
        EnumToStringConverter::getAnnotation);

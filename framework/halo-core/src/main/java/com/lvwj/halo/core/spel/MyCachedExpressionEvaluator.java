 ...
 */
public class MyCachedExpressionEvaluator extends CachedExpressionEvaluator {

  public static final MyCachedExpressionEvaluator INSTANCE = new MyCachedExpressionEvaluator();

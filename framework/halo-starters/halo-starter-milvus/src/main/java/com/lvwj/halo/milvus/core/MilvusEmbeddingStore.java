...
public class MilvusEmbeddingStore implements EmbeddingStore<TextSegment> {
    ...
    public void add(TextEmbeddingEntity entity) {
        addInternal(entity.getId(), entity.getEmbedding(), entity.getTextSegment());
    }
     ...
     */
    public void save(String id, Embedding embedding) {
     ...
     * save = upsert = add or update
     */
    public void save(String id, Embedding embedding, TextSegment textSegment) {
        upsertInternal(id, embedding, textSegment);
    }
    ...
    public void save(TextEmbeddingEntity entity) {
        upsertInternal(entity.getId(), entity.getEmbedding(), entity.getTextSegment());
    }
    ...
    public void saveList(List<TextEmbeddingEntity> entities) {
        ...
        upsertAllInternal(ids, embeddings, textSegments);
    }
    ...
    private void upsertAllInternal(List<String> ids, List<Embedding> embeddings, List<TextSegment> textSegments) {
